...
@MainFetch@: with this task you can download pages for a specific task.
* First parameter: the task properties file.
* Second parameter (optional): the project properties file.

@MainFetchRSS@: with this task you can download pages from the RSS Feed (Special:RecentChanges) of the MediaWiki Instance. Because this feed provide information on the revisionId of the change, only newer page are considered.
