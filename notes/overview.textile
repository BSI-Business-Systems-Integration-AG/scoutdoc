...
There are different Main class to fetch pages:

@MainFetch@: with this class you can download pages for a specific task.
* First parameter: the task properties file.
* Second parameter (optional): the project properties file.

@MainFetchRSS@: with this class you can download pages from the RSS Feed (Special:RecentChanges) of the MediaWiki Instance. Because this feed provide information on the revisionId of the change, only newer page are considered.
* First parameter (optional): the project properties file.

@MainFetchAll@: with this class you can download a list of pages (provided in a txt file) or refresh all pages you have in the source folder. 
* First parameter (optional): the project properties file.
* Second parameter (optional): the list of pages. (if not provided, the page list is computed from the source folder).
...
Java main class: @MainCheckAll@ to check all pages of the @wiki_src@ directories
* First parameter (optional): the project properties file.
* Second parameter (optional): the name of the output file (default: Checkstyle.xml) 

Java main class: @MainCheck@
* First parameter: the task properties file. (It is possible to provide the name of the outfile in the task)
* Second parameter (optional): the project properties file.
